...
public class LoginRegex {
    ...
    public static boolean setTextColour(LoginTextField location, TextField textField) {
        if (LoginRegex.isTextFieldValid(location, textField.getText())) {
    ...
    private static boolean isTextFieldValid(LoginTextField textField, String text) {
