...
public class SupplierRegex {
    public static boolean setTextColour(SupplierTextField location, TextField textField) {

        if (SupplierRegex.isTextFieldValid(location, textField.getText())) {
    ...
    private static boolean isTextFieldValid(SupplierTextField textField, String text) {
